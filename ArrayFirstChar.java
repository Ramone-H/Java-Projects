//This program will print the first repeated character in an Array
import java.util.*;
public class ArrayFirstChar {
...
System.out.println(" ");
// The index of zero will return the first value of an array. 
System.out.println("The first value to repeat was: "+ repeaters[0]);
System.out.println("");
}
